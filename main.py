...
# dataset paths 
train_txt_path='data_with_fake_img/train_data_file.csv' 
train_img_dir='data_with_fake_img/train'
test_text_path='data_with_fake_img/test_data_file.csv'
test_img_dir='data_with_fake_img/validation'
